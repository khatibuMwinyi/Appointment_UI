        ...
        >
          ...
          <ul className="flex flex-col items-center gap-2 mt-5 px-5 text-lg font-medium">
            <NavLink onClick={() => setShowMenu(false)} to="/">
              <p className="rounded inline-block px-4 py-2">HOME</p>
            </NavLink>
            <NavLink onClick={() => setShowMenu(false)} to="/doctors">
              <p className="rounded inline-block px-4 py-2">ALL DOCTORS</p>
            </NavLink>
            <NavLink onClick={() => setShowMenu(false)} to="/about">
              <p className="rounded inline-block px-4 py-2">ABOUT</p>
            </NavLink>
            <NavLink onClick={() => setShowMenu(false)} to="/contact">
              <p className="rounded inline-block px-4 py-2">CONTACT</p>
            </NavLink>
          </ul>
        </div>
      </div>
